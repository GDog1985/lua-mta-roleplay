...
function showNotificationBox( )
	...
	local text_width, text_height = dxGetTextWidth( cegui.errors.phrases[ cegui.errors.current ][ 3 ] .. cegui.errors.phrases[ cegui.errors.current ][ 1 ] ), dxGetFontHeight( )
	dxDrawRectangle( 0, screen_height - 40, screen_width, screen_height, cegui.errors.phrases[ cegui.errors.current ][ 2 ] )
	dxDrawText( cegui.errors.phrases[ cegui.errors.current ][ 3 ] .. cegui.errors.phrases[ cegui.errors.current ][ 1 ], ( screen_width - text_width ) / 2 + 1, screen_height - 40 + 16, text_width, text_height, tocolor( 4, 4, 4, 85 ) )
	dxDrawText( cegui.errors.phrases[ cegui.errors.current ][ 3 ] .. cegui.errors.phrases[ cegui.errors.current ][ 1 ], ( screen_width - text_width ) / 2, screen_height - 40 + 15, text_width, text_height, tocolor( 240, 240, 240, 200 ) )
end
